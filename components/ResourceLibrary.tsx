...
export function ResourceLibrary() {
  ...
  return (
    <div className="flex h-full bg-[#1e1e1e] text-slate-200 overflow-hidden w-full">
      {/* Sidebar - hidden on mobile if too narrow, or just adjusted */}
      <div className="hidden md:flex w-56 border-r border-slate-800 flex-col bg-[#1e1e1e] shrink-0">
        <div className="p-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-1.5 bg-[#252526] border border-slate-800 rounded-xl text-xs text-slate-200 focus:outline-none focus:border-teal-500 transition-colors"
            />
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden w-full">
        <div className="px-4 md:px-6 py-3 border-b border-slate-800 flex flex-wrap items-center justify-between gap-3 bg-[#1e1e1e]/80 backdrop-blur-md">
          <div className="flex items-center gap-1.5 text-xs font-medium overflow-hidden">
            <button 
            ...
            {breadcrumbs.map(crumb => (
              <React.Fragment key={crumb.id}>
                ...
                <button 
                  ...
                  className="text-slate-400 hover:text-slate-200 transition-colors truncate max-w-[100px]"
                >
                  {crumb.name}
                </button>
              </React.Fragment>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 bg-[#252526] hover:bg-slate-800 text-slate-300 rounded-lg text-xs transition-colors border border-slate-800"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 bg-teal-600 hover:bg-teal-500 text-white rounded-lg text-xs font-medium transition-all shadow-lg shadow-teal-900/20"
            >
        ...
        <div 
          ...
          onDrop={handleDrop}
          className={clsx(
            "flex-1 p-4 md:p-6 overflow-y-auto custom-scrollbar transition-colors",
        ...
        >
          {currentResources.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-slate-500 space-y-4">
              ...
              <p className="text-sm text-center px-4">文件夹为空，拖拽文件或文件夹到此处上传</p>
            </div>
          ) : (
            <div className="grid grid-cols-2 xs:grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-8 gap-4 md:gap-6">
